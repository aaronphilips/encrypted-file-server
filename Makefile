...
EncryptedMessage.class:EncryptedMessage.java
	javac EncryptedMessage.java
...
lib_TEA.so:lib_TEA.c
	gcc -I${JAVA_HOME}/include -I${JAVA_HOME}/include/linux -shared -fpic -o lib_TEA.so lib_TEA.c encrypt.c decrypt.c
